                ...
                {["high", "medium", "low"].map((level) => (
                  <div key={level} className="flex items-center gap-2">
                    <button
                      ...
                      className={`w-6 h-6 rounded-full border-2 border-gray-400 flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer ${
                        priority === level
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {FILTER_OPTIONS.map(({ key, label }) => (
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-full transition-all duration-300 hover:scale-105 hover:cursor-pointer ${
                      filter === key
                        ? " text-purple-600"
          ...
          <div className="space-y-4">
            {filteredTasks.map((task) => (
              <div
                key={task.id}
                id={task.id}
                className={` rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border-l-4 ${
